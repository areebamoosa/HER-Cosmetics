    ...
    return (
        <>
            <div className='text-white flex justify-between items-center mt-6 text-2xl '>
                ...
                <h1 className='headFont dark-pink cursor-pointer ml-10 whitespace-nowrap sm:text-2xl lg:text-3xl sm:ml-25 lg:ml-50'><Link to='/'><span className="inline-block animate-door-rotate">H</span>ER COSMETICS </Link>
                </h1>
