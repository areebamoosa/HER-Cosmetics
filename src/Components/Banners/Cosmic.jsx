        ...
        <>
            ...
            <div className='black relative mt-10'>
                ...
                <div className='absolute bottom-1/3  left-[70px]  flex justify-center items-start  flex-col'>
                    <div>
                        <h1 className='text-white font font-semibold text-2xl'>COSMIC 2.0 WINTER</h1>
                        <h1 className='text-white font font-semibold mt-3 text-2xl'>MAKEUP COLLECTION</h1>
                    </div>

                    <div className='font text-xl mt-6 text-white flex flex-col gap-1'>
