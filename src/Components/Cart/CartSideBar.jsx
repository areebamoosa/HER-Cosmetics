        ...
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          <div className="flex-1 overflow-y-auto mb-40">
            ...
            <div className="flex justify-center items-center mt-5">
              <p className="grey text-base sm:text-lg">your order qualifies for free shipping</p>
            </div>
            ...
            <div className="flex rounded-lg p-5 light-pink justify-start items-start w-80 sm:w-130 h-35 gap-5">
              ...
              <div>
                <span className="sm:text-lg text-sm font-medium">new! 12 days of her's advent calender 🎁</span>
                <p className="grey text-sm lg:text-md">limited edition & online exclusive</p>
                <span className="text-sm sm:text-lg font-medium underline hover:text-white cursor-pointer">shop now</span>
              </div>
            </div>
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 flex flex-col justify-between">
                            <div className="flex justify-between items-start ">
                              <div>
                                <p className="font-semibold mt-1 text-xs lg:text-base whitespace-nowrap">{item.title} - ${item.price}</p>
                                <p className="text-xs  sm:text-sm text-gray-600 mt-2">{item.desc}</p>
                              </div>
                              <button
                            ...
                            <div className="self-end mt-3">
                              <div className="sm:px-4 px-1 py-1 border border-black rounded-md w-25 sm:w-28 h-10 flex justify-around items-center">
            ...
            <div className="mt-10 mb-10 ">
              <span className="text-sm sm:text-xl font-semibold ">1 free mini deluxe sample with any $40+ order</span>
              <p className="grey text-sm sm:text-md mt-5">choose free samples (1 remaining)</p>
          ...
          <div className="fixed bottom-0 left-0 p-5 w-full h-40 flex flex-col gap-2 bg-white">
            <div className="flex text-base sm:text-xl font-semibold justify-between items-center font">
              <p>estimated total</p>
              <span>${total.toFixed(2)}</span>
            </div>
            <p className="grey">shipping & discounts calculated at checkout</p>
            <Link to="/checkout"><button className="bg-black text-white  sm:px-5 py-2 w-90 sm:w-140 rounded-md cursor-pointer">checkout</button></Link>
          </div>
        </div>
      </div>
    </>
